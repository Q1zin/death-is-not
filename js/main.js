      ...
      $.ajax({
        ...
        if (data2 != null) {
          $.each(data2, function (index, data2) {
            swiper.appendSlide("<div class=\"content__card swiper-slide\"><img class=\"content__card--img\" src=\"http://img.youtube.com/vi/" + data2.link + "/mqdefault.jpg\" alt=\"img: превью видео\"><span class=\"content__card--text\">" + data2.content + "</span><span class=\"content__card--more\"><a class=\"content__card--link\" target=\"_blank\" href=\"https://www.youtube.com/watch?v=" + data2.link + "\">Подробнее</a></span></div>");
          });
          num2 += 6;
          if (num2 >= mynum2) {
      ...
      $.ajax({
        ...
        if (data3 != null) {
          $.each(data3, function (index, data3) {
            if (data3.preview == ''){
            $(".all-dtp__content-wrap").append("<div class=\"all-dtp__card\"><img src=\"img/default.svg\" alt=\"img: dtp\" class=\"all-dtp__card-img\"><div class=\"all-dtp__card-wrap\"><span class=\"all-dtp__card-title\">" + data3.name + "</span><span class=\"all-dtp__card-text\">" + data3.description + "</span><a class=\"all-dtp__card-btn\" href=\"info-dtp.php?article="+ data3.id + "\">Подробнее</a></div></div>");
            } else {
              $(".all-dtp__content-wrap").append("<div class=\"all-dtp__card\"><img src=\"http://img.youtube.com/vi/" + data3.preview + "/mqdefault.jpg\" alt=\"img: dtp\" class=\"all-dtp__card-img\"><div class=\"all-dtp__card-wrap\"><span class=\"all-dtp__card-title\">" + data3.name + "</span><span class=\"all-dtp__card-text\">" + data3.description + "</span><a class=\"all-dtp__card-btn\" href=\"info-dtp.php?article="+ data3.id + "\">Подробнее</a></div></div>");
            }
          });
          num3 += 12;
        };

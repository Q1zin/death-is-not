...
<body>
        ...
        <div class="information-wrap">
            <div class="information-left">
                ...
                <div class="information-left__text">
                    <p class="information-left__text--p">Меня зовут Василий Орлов и уже более двух лет я веду ютуб-канал
                        о
    ...
    <div class="modal-reg">
        ...
        <span class="modal-reg__error">Что-то пошло не так((</span>
    ...
    <div class="modal-don">
        <a href="#" class="modal-close__link">
        ...
        <div class="modal-don-big__wrap">
            ...
            <div class="modal-don-big__information">
                <input class="modal-don-big__information--item" placeholder="Фамилия*" type="text" name="us_last_name">
                <input class="modal-don-big__information--item" placeholder="Имя*" type="text" name="us_name">
                <input class="modal-don-big__information--item" placeholder="Ваш e-mail*" type="email" name="em">
            </div>
            <input class="modal-don-big__sub" type="submit" value="Пожервовать проекту">
            <span class="modal-don-big__agreement">Заполняя форму, вы принимаете договор-оферту и соглашаетесь на
                обработку персональных данных.</span>
